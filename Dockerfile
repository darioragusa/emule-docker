...
RUN wget https://github.com/irwir/eMule/releases/download/eMule_v0.72a-community/emule0.72a_beta9.zip -O /tmp/emule.zip && \
    unzip /tmp/emule.zip -d /tmp/eMule0.72a_beta9 && mv /tmp/eMule0.72a_beta9/* /app
